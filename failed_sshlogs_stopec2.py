# Extract the EC2 instance ID from the Alarm Description, and stop the instance.
# https://github.com/linuxacademy/la-aws-security_specialty/tree/master/Troubleshooting-Detection-Alerting-Response-Workflow
