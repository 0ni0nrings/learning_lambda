...
# Remediates CVE findings of Amazon Inspector agent
# SNS notification as trigger, subscribe this function to a SNS topic
# cat /var/log/yum.log --> check what packages were updated on the EC2 instance
